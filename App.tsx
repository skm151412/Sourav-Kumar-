...
const resumePdfUrl = new URL('./SOURAV KUMAR.pdf', import.meta.url).href;
...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full glass-card border-t border-white/60 p-5 sm:p-6 flex flex-col gap-4 max-h-[calc(100svh-5rem)] overflow-y-auto">
          {navLinks.map((link) => (
            <a 
              key={link.label} 
              href={link.href} 
...
const Hero = () => {
        ...
        content: (
          <>
            <div className="flex gap-2">
              ...
              <span className="code-yellow">Engineer</span>
      ...
      },
      {
        ...
        content: (
          <>
              <div className="flex gap-2">
              <span className="text-purple-400">const</span>
              <span className="code-yellow">Focus</span>
              <span className="text-primary">=</span>
              <span className="text-primary">{`{`}</span>
            </div>
            <div className="pl-6 flex gap-2">
      ...
      },
      {
        ...
        content: (
          <>
            <div className="flex gap-2">
              <span className="text-purple-400">const</span>
              <span className="code-yellow">Projects</span>
              <span className="text-primary">=</span>
              <span className="text-primary">{`{`}</span>
            </div>
            <div className="pl-6">
      ...
      },
      {
        ...
        content: (
          <>
            <div className="flex gap-2">
              <span className="text-purple-400">const</span>
              <span className="code-yellow">WorkStyle</span>
              <span className="text-primary">=</span>
              <span className="text-primary">{`{`}</span>
            </div>
            <div className="pl-6 flex gap-2">
      ...
      },
      {
        ...
        content: (
          <>
            <div className="flex gap-2">
              <span className="text-purple-400">const</span>
              <span className="code-yellow">Availability</span>
              <span className="text-primary">=</span>
              <span className="text-primary">{`{`}</span>
            </div>
            <div className="pl-6 flex gap-2">
  ...
  return (
    <section id="hero" className="hero-shell relative min-h-[92svh] flex items-center justify-center pt-24 md:pt-28 pb-16 md:pb-24">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-10 xl:gap-14 items-center">
        <div className="space-y-6 lg:space-y-8 max-w-3xl order-1">
          ...
          <HeroReveal delay={heroDelays * 1}>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-primary tracking-tight leading-[1.05]">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-4 hero-cta">
            <HeroReveal as="div" delay={heroDelays * 3} distance={0} initialTransform="translate3d(0, 0, 0)">
              <a
                href="#projects"
                className="button-glow-primary w-full sm:w-auto justify-center px-8 py-3.5 bg-cyan-500 text-[#0f172a] font-bold rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400"
              >
                View Projects
              </a>
            </HeroReveal>
            <HeroReveal as="div" delay={heroDelays * 3 + animationConfig.staggering.hero}>
              <a
                href="#contact"
                className="button-outline-secondary w-full sm:w-auto justify-center px-8 py-3.5 bg-transparent text-primary font-medium rounded-xl"
              >
                Contact Me
              </a>
            </HeroReveal>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 pt-4 text-muted">
            ...
            <a href="https://www.linkedin.com/in/sourav-kumar-046165369/" target="_blank" rel="noreferrer" className="icon-hover text-muted hover:text-primary transition-colors flex items-center gap-2" aria-label="Sourav's LinkedIn"><ExternalLink size={24} /> <span className="text-sm font-medium">LinkedIn</span></a>
            <div className="hidden sm:block h-px w-12 bg-[#cbd5f5]"></div>
        ...
        <div className="order-2 flex justify-center relative lg:justify-center">
          <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg aspect-square motion-float-slow">
            ...
            <div className="absolute inset-0 bg-white/95 rounded-2xl border border-white/80 backdrop-blur-md flex flex-col p-4 sm:p-6 shadow-xl -rotate-3 hover:rotate-0 transition-transform duration-500">
              <div className="flex items-center gap-2 mb-4 sm:mb-6 border-b border-[#e2e8f0] pb-4">
                <div className="w-3 h-3 rounded-full bg-red-500/80"></div>
                <div className="w-3 h-3 rounded-full bg-yellow-500/80"></div>
                <div className="w-3 h-3 rounded-full bg-green-500/80"></div>
                <span className="ml-auto text-xs text-muted font-mono">App.tsx</span>
              </div>
              <div className="font-mono text-xs sm:text-sm text-secondary leading-relaxed">
            ...
            <button
              ...
              className="absolute -top-4 -right-2 sm:-top-6 sm:-right-6 p-3 sm:p-4 glass-card rounded-xl shadow-lg motion-float-reverse transition-transform duration-200 hover:scale-[1.03] active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
            >
              <Code2 className="text-[#2563eb]" size={20} />
            </button>
            <div className="absolute -bottom-4 left-2 sm:-bottom-8 sm:-left-4 p-3 sm:p-4 glass-card rounded-xl shadow-lg motion-float-slow">
...
const About = () => {
  ...
  return (
    <section id="about" className="about-shell py-20 md:py-28 relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-10 xl:gap-16 items-start">
          ...
          <InViewReveal className="space-y-10" direction="left" threshold={0.35}>
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-6">About Sourav</h2>
          ...
          <InViewReveal className="relative" direction="right" threshold={0.35}>
            ...
            <div className="relative glass-card rounded-2xl p-6 sm:p-8 md:p-10 student-advantage-card">
              ...
              <div className="mt-8 pt-6 border-t border-[#e2e8f0] flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-green-500/10 rounded-full">
                    <Download className="text-green-400 w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-primary font-medium text-sm">SOURAV KUMAR.pdf</div>
                    <div className="text-xs text-muted">Updated Jan 2026</div>
                  </div>
                </div>
                <a href={resumePdfUrl} download="SouravKumar.pdf" className="text-sm font-medium text-cyan-400 hover:text-cyan-300 flex items-center gap-1 transition-colors">
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="skills-shell py-20 md:py-28 relative">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <InViewReveal as="div" className="text-center mb-16" direction="up" distance={16}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-4">Technical Arsenal</h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
          {skillCategories.map((category, idx) => (
            <InViewReveal key={category.title} delay={Math.floor(idx / 3) * animationConfig.staggering.cards} distance={16}>
              <div className="group glass-card p-6 sm:p-8 rounded-2xl relative overflow-hidden skill-card">
                ...
                <p className="text-sm text-secondary mb-6">{category.description}</p>
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="projects-shell py-20 md:py-28 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col gap-4 md:flex-row md:justify-between md:items-end mb-12 md:mb-16">
          <div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-4">Featured Projects</h2>
        ...
        <div className="space-y-16 md:space-y-20">
          {projects.map((project, idx) => (
            <InViewReveal
              ...
              delay={idx * 120}
            >
              <article className={`project-card glass-card w-full flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch p-5 sm:p-6 lg:p-8 ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                {/* Image Card */}
                ...
                <div className="w-full lg:w-1/2 space-y-5 sm:space-y-6">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-primary">{project.title}</h3>
                  
                  <div className="p-4 rounded-lg bg-white/90 border-l-4 border-[#38bdf8]/40">
                    <p className="text-primary italic">"{project.problem}"</p>
                  </div>
                  
                  <p className="text-secondary leading-relaxed text-base lg:text-lg">{project.description}</p>
...
const Deployments = () => {
  ...
  return (
    <section id="deployments" className="deployments-shell py-20 md:py-24">
...
const Education = () => {
  return (
    <section id="education" className="education-shell py-20 md:py-28 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-4">Education</h2>
        ...
        <InViewReveal direction="up" distance={12}>
          <div className="glass-card rounded-2xl p-6 sm:p-8 md:p-10 flex flex-col gap-3 text-center">
...
const Contact = () => {
  return (
    <section id="contact" className="contact-shell py-20 md:py-28 relative">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <InViewReveal direction="up" distance={16}>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-6">Ready to Contribute?</h2>
        ...
        <InViewReveal direction="up" distance={20} delay={120}>
          <div className="cta-card glass-card p-8 rounded-2xl inline-block w-full max-w-lg text-left">
            <div className="flex flex-col gap-4">
               ...
               <a href="https://www.linkedin.com/in/sourav-kumar-046165369/" target="_blank" rel="noreferrer" className="button-outline-secondary flex items-center justify-between w-full font-medium py-4 px-5 rounded-xl">
...
const Footer = () => {
  return (
    <footer className="py-8 border-t border-[#e2e8f0] bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0 text-secondary text-sm text-center md:text-left">
        <p className="text-secondary">© 2025 Sourav Kumar. Built with React & Tailwind CSS.</p>
          ...
          <a href="https://www.linkedin.com/in/sourav-kumar-046165369/" target="_blank" rel="noreferrer" className="hover:text-[#2563eb] transition-colors">LinkedIn</a>
